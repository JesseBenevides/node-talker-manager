Projeto desenvolvido durante o perído de estudos na Trybe.

---

# Boas vindas ao repositório do Talker Manager!

O projeto consiste em desenvolver uma API de um CRUD (**C**reate, **R**ead, **U**pdate e **D**elete) de palestrantes. Será desenvolvido alguns endpoints que irão ler e escrever em um arquivo, isso utilizando o módulo `fs`.

API será desenvolvida com Node e Express
...
- `git clone git@github.com:JesseBenevides/node-talker-manager.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd node-talker-manager`
